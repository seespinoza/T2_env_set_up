...
public class DBConnection {
   ...
   static void getDBConnection() {
      ...
      connection = null;
      try {
         UtilPropSebastian.loadProperty(servletContext);
   ...
   static String getURL() {
      String url = UtilPropSebastian.getProp("url");
      System.out.println("[DBG] URL: " + url);
      return url;
   }

   static String getUserName() {
      String usr = UtilPropSebastian.getProp("user");
      System.out.println("[DBG] URL: " + usr);
      return usr;
   }

   static String getPassword() {
      String pwd = UtilPropSebastian.getProp("password");
